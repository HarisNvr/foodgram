...
Проект доступен по [адресу](foodgram.servehalflife.com)

Документация к API доступна [здесь](foodgram.servehalflife.com/api/docs/)
...
```
https://github.com/HarisNvr/foodgram.git
```
